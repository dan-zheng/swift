...
#warning TODO: replace concrete zero materialization with symbolic `AdjointValue` creation
    ...
    return (insertion.first->getSecond() = makeConcreteAdjointValue(newBuf));
  }
