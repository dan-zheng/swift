...
AnyFunctionType *AnyFunctionType::getAutoDiffReturnedLinearMapFunctionType(
  ...
  case AutoDiffLinearMapKind::Differential: {
    // Compute the differential type, returned by the JVP.
    //
  ...
  case AutoDiffLinearMapKind::Pullback: {
    // Compute the pullback type, returned by the VJP.
    //
    ...
    auto flags = ParameterTypeFlags().withInOut(originalResult.isInout);
    auto pullbackParam =
