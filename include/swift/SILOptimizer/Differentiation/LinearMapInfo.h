...
private:
  ...
  /// Adds an enum element declaration to the given branching trace enum for the
  /// given predecessor and original basic blocks.
  void addBranchingTraceEnumElement(SILBasicBlock *predBB,
                                    SILBasicBlock *originalBB,
