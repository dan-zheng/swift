...
struct TF_1190_Outer: Differentiable {
  // expected-warning @+1 {{synthesis of the 'Differentiable.move(along:)' requirement for 'TF_1190_Outer' requires all stored properties not marked with `@noDerivative` to be mutable; add 'Wrapper.wrappedValue.set', or add an explicit '@noDerivative' attribute}}
